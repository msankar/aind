...
def cornersHeuristic(state, problem):
  ...
  """
  corners = problem.corners  # Corners
  walls = problem.walls  # Walls

  node = state[0] # State is the current search state.
  visitedCorners = state[1]
  unvisitedCorners = []
  ...
  while len(unvisitedCorners) > 0:
    # Get min manhattan distance from curr pt to corner for each of the unvisited corners.
...
def foodHeuristic(state, problem):
  ...
  allFoods = list(foodGrid.asList()) # list of food coordinates.
